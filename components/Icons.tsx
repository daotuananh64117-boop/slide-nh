...
export const FilmIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 3.75V20.25m12-16.5V20.25M4.5 3.75h15m-15 4.5h15m-15 4.5h15m-15 4.5h15" />
  </svg>
);
...
export const LandscapeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <rect x="2" y="5" width="20" height="14" rx="2" strokeWidth="1.5" fill="none" />
  </svg>
);
...
export const PortraitIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <rect x="5" y="2" width="14" height="20" rx="2" strokeWidth="1.5" fill="none" />
  </svg>
);